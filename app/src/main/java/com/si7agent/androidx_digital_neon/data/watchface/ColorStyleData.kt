...
enum class ColorStyleData(
    ...
    AMBIENT(
        ...
        hourPipsStyleDrawableId = R.drawable.theme1_watch,
        secondStyleDrawableId = R.drawable.theme1_neon_bg,
        appLauncherStyleDrawableId = R.drawable.theme1_ic_app_manager,
    ...
    RED(
        ...
        hourPipsStyleDrawableId = R.drawable.theme2_watch,
        secondStyleDrawableId = R.drawable.theme2_neon_bg,
        appLauncherStyleDrawableId = R.drawable.theme2_ic_app_manager,
    ...
    GREEN(
        ...
        hourPipsStyleDrawableId = R.drawable.theme4_watch,
        secondStyleDrawableId = R.drawable.theme4_neon_bg,
        appLauncherStyleDrawableId = R.drawable.theme4_ic_app_manager,
    ...
    PURPLE(
        ...
        hourPipsStyleDrawableId = R.drawable.theme3_watch,
        secondStyleDrawableId = R.drawable.theme3_neon_bg,
        appLauncherStyleDrawableId = R.drawable.theme3_ic_app_manager,
